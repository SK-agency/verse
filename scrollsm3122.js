...
!function(e, t) {
    ...
    function ScrollSmoother(t) {
        ...
        function Xa(e) {
            w.scrollTop = 0,
            e.target.contains && e.target.contains(w) || T && !1 === T(o, e) || (V.isInViewport(e.target) || e.target === g || o.scrollTo(e.target, !1, "center center"), g = e.target)
        }
        function Ya(t, e) {
            if (t < e.start)
                return t;
        ...
        function eb(r, e, t, n, o) {
            function pc() {
                ...
                s = "auto" === e.value,
                c = s || a && a._startClamp && a.start <= 0 || p.offset ? 0 : a && a._endClamp && a.end === D() ? 1 : .5,
                l && l.kill(),
                l = t && B.to(r, {
                    ease: Q,
                    overwrite: !1,
                        ...
                        if (i) {
                            for (r = -A, n = e.end; i--;) {
                                if ((t = p[i]).trig.isActive || r >= t.start && r <= t.end)
                                    return void (l && (t.trig.progress += t.trig.direction < 0 ? .001 : -.001, t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(g.y), -H, !0), O && l.progress(1)));
        ...
        this.scrollTo = function(e, t, r) {
            var n = B.utils.clamp(0, D(), isNaN(e) ? o.offset(e, r) : +e);
            t ? f ? B.to(o, {
                duration: R,
                scrollTop: n,
                overwrite: "auto",
        ...
        this.offset = function(e, t) {
            var r,
                n = (e = W(e)[0]).style.cssText,
                o = V.create({
                    trigger: e,
                    start: t || "top top"
                });
            return S && (O ? V.refresh() : $a([o], !0)), r = o.start / k, o.kill(!1), e.style.cssText = n, B.core.getCache(e).uncache = 1, r
        },
        ...
        i = V.create({
            ...
            onRefreshInit: function onRefreshInit(e) {
                if (!ScrollSmoother.isRefreshing) {
                    ...
                    u = A,
                    M.y = 0,
                    R && (1 === V.isTouch && (w.style.position = "absolute"), w.scrollTop = 0, 1 === V.isTouch && (w.style.position = "fixed"))
                }
            },
        ...
        V.config(t),
        "overscrollBehavior" in L.getComputedStyle(j) && B.set([j, I], {
